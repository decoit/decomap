...
import de.simu.decomap.component.mapping.impl.SnortFileAttackDetectedMapper;
import de.simu.decomap.component.polling.PollingThread;
import de.simu.decomap.component.polling.impl.SnortFilePollingThread;
 ...
 * 
 */
public class SnortAttackDetectedFilePollingModule extends AbstractModule {

	@Override
	protected void configure() {
		bind(PollingThread.class).to(SnortFilePollingThread.class);
		bind(MappingInterface.class).to(SnortFileAttackDetectedMapper.class);
		bind(MappingResultType.class).toInstance(MappingResultType.ATTACKDETECTED);
