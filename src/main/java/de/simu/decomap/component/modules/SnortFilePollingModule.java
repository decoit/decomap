...
import de.simu.decomap.component.mapping.impl.SnortFileEventMapper;
 ...
 * 
 */
public class SnortFilePollingModule extends AbstractModule {

	@Override
	protected void configure() {
		bind(PollingThread.class).to(SnortFilePollingThread.class);
		bind(MappingInterface.class).to(SnortFileEventMapper.class);
