...
import de.simu.decomap.component.mapping.impl.OpenVPNMapper;
import de.simu.decomap.component.polling.PollingThread;
import de.simu.decomap.component.polling.impl.OpenVPNFilePollingThread;
 ...
 * 
 */
public class OpenVPNFilePollingModule extends AbstractModule {

	@Override
	protected void configure() {
		bind(PollingThread.class).to(OpenVPNFilePollingThread.class);
		bind(MappingInterface.class).to(OpenVPNMapper.class);
		bind(MappingResultType.class).toInstance(MappingResultType.OPENVPN);
