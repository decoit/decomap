...
import de.simu.decomap.component.polling.impl.SimpleFilePollingThread;
...
import de.simu.decomap.component.mapping.impl.*;
 ...
 * 
 */
public class LdapFilePollingModule extends AbstractModule {

	@Override
	protected void configure() {
		bind(PollingThread.class).to(SimpleFilePollingThread.class);
		bind(MappingInterface.class).to(LdapEventMapper.class);
