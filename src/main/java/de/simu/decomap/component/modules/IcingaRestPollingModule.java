...
import de.simu.decomap.component.mapping.impl.IcingaRestEventMapper;
import de.simu.decomap.component.polling.*;
import de.simu.decomap.component.polling.impl.IcingaRestPollingThread;
 ...
 * 
 */
public class IcingaRestPollingModule extends AbstractModule {

	@Override
	protected void configure() {
		bind(PollingThread.class).to(IcingaRestPollingThread.class);
		bind(MappingInterface.class).to(IcingaRestEventMapper.class);
