...
import de.simu.decomap.component.mapping.impl.RadiusEventMapper;
import de.simu.decomap.component.polling.PollingThread;
import de.simu.decomap.component.polling.impl.RadiusFilePollingThread;
 ...
 * 
 */
public class RadiusFilePollingModule extends AbstractModule {

	@Override
	protected void configure() {
		bind(PollingThread.class).to(RadiusFilePollingThread.class);
		bind(MappingInterface.class).to(RadiusEventMapper.class);
		bind(MappingResultType.class).toInstance(MappingResultType.SIMUROLEACCESSREQUEST);
